...
describe('SearchIndex', () => {
  ...
  it('should build index from documents', () => {
    const docs = [
      ...
      createDoc({ id: 'doc-2', title: 'Hash Maps', content: 'Hash maps provide O(1) lookup' }),
    ];
  ...
  it('should update a document', () => {
    const doc = createDoc({ id: 'doc-1', title: 'Original Title', content: 'original content about arrays' });
...
describe('search()', () => {
  ...
  beforeEach(() => {
    index = new SearchIndex();
    index.buildIndex([
      createDoc({ id: 'topic-1', type: 'topic', title: 'Binary Trees', content: 'tree traversal algorithms' }),
      createDoc({ id: 'problem-1', type: 'problem', title: 'Two Sum', content: 'find two numbers that add up to target' }),
      createDoc({ id: 'flashcard-1', type: 'flashcard', title: 'What is DFS?', content: 'Depth first search traversal' }),
    ]);
  });
  ...
  it('should respect limit option', () => {
    index.buildIndex(
      Array.from({ length: 30 }, (_, i) =>
        createDoc({ id: `doc-${i}`, title: `Topic ${i}`, content: 'common search term' })
      )
    );
  ...
  it('should default limit to 20', () => {
    index.buildIndex(
      Array.from({ length: 30 }, (_, i) =>
        createDoc({ id: `doc-${i}`, title: `Topic ${i}`, content: 'shared keyword' })
      )
    );
  ...
  it('should search by tags', () => {
    index.buildIndex([
      createDoc({ id: 'tagged', title: 'Something', content: 'unrelated', tags: ['recursion', 'backtracking'] }),
    ]);
...
describe('buildSearchDocuments()', () => {
  it('should convert topics to search documents', () => {
    ...
    const topics: TopicContent[] = [{ topic, overview: 'Overview of binary trees', notes: 'Notes on traversals' }];
  ...
  it('should convert problems to search documents', () => {
    ...
    const problems: ProblemContent[] = [{ problem, notes: 'Use a hash map for O(n) solution' }];
