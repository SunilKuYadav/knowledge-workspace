...
/**
 * A comprehensive test suite generated by AI for a problem or variation.
 * Contains categorized test cases covering all possible scenarios.
 */
export const GeneratedTestSuiteSchema = z.object({
  id: z.string(),
  /** Which target: "main" for the problem, or a variation ID */
  targetId: z.string(),
  /** Categorized test case groups */
  categories: z.array(
    z.object({
      name: z.string(),
      description: z.string(),
  ...
  /** Total count of all test cases across categories */
  totalCount: z.number(),
...
export const ProblemDescriptionSchema = z.object({
  ...
  /** AI-generated comprehensive test suites (main + per-variation) */
  generatedTestSuites: z.array(GeneratedTestSuiteSchema).optional(),
  generatedAt: z.string(),
  updatedAt: z.string(),
});
