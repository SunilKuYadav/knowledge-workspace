...
describe('generateCommitMessage', () => {
  it('generates a create message with item title', () => {
    const msg = generateCommitMessage('create', 'notes for topic', 'Binary Trees');
    expect(msg).toBe('Create notes for topic: Binary Trees');
  });

  it('generates an update message with item title', () => {
    const msg = generateCommitMessage('update', 'solution for problem', 'Two Sum');
  ...
  it('generates a fallback message for create without title', () => {
    const msg = generateCommitMessage('create', 'notes/dsa/binary-trees/notes.md');
